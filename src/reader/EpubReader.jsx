    ...
    async function init() {
      ...
      rendition.themes.default({
        body: {
          ...
          'font-family': settings.fontFamily === 'inter' ? 'Inter, sans-serif' : settings.fontFamily === 'serif' ? 'Georgia, serif' : 'Literata, serif'
        },
        p: {
          color: 'var(--reader-fg) !important'
        },
      ...
      const initial = book.currentLocation?.cfi || undefined;
