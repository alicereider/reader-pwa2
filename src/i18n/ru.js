...
export const t = {
  ...
  settings: {
    ...
    mobileUxCopy: 'Коснись центра экрана, чтобы показать или скрыть панели. При чтении вниз прокрутка остаётся мягкой и не дёргает текст.'
  },
  reader: {
    ...
    brightness: 'Яркость',
    mobileModeHint: 'На телефонах всегда включена вертикальная прокрутка: вниз книга идёт плавно, без резких рывков и псевдолистания.',
